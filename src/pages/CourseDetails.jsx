    ...
    <>
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          {/* Render reviews at the bottom */}
          {ratingAndReviews && ratingAndReviews.length > 0 && (
            <div className="mt-12 border-t border-richblack-600 pt-8">
              <h2 className="text-2xl font-bold mb-4 text-richblack-5">
                Student Reviews
              </h2>
              <div className="space-y-6">
                {ratingAndReviews.map((review) => (
                  <div
                    key={review._id}
                    className="border-b border-richblack-700 pb-4"
                  >
                    ...
                    <div className="text-richblack-25">{review.review}</div>
                  </div>
                ))}
              </div>
            </div>
